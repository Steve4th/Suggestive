Web site will manage a and display a list of feedback items (named - user reports/ enhancements/ suggestions/ feedback item ?)
...
Creating a feedback item
 ...
 - User must be authenticated to create an item
...
Voting:
	...
	A user can modify their vote on an item at any point.
